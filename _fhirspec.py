...
class FHIRSpec(object):
    ...
    def __init__(self, directory, settings):
        ...
        self.definition_directory = directory / "definitions"
        self.example_directory = directory / "examples_json"
                ...
                if (
                    ...
                    props.append(
                        fhirclass.FHIRClassProperty(
                            self, type_obj, self.name_if_class()
                        )
                    )
...
class FHIRStructureDefinitionElementDefinition(object):
    ...
    def resolve_dependencies(self):
        ...
        if self.content_reference is not None:
            ...
            if elem is None:
                raise Exception(
                    'There is no element definiton with id "{}", as referenced by {} in {}'.format(
